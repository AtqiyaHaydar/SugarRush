...
const page = () => {
  ...
  return (
    <div className='w-full mt-2 grid grid-cols-3 gap-6'>
      <div className='relative bg-gradient-to-r from-pink-primary to-orange-primary overflow-hidden rounded-[50px] p-6 h-[74vh]'>
        
        <div data-aos="fade-right">
          <h1 className='text-white text-3xl font-OpenSauceSans-Bold mb-3 Extramt-2'>
          Decadent Desserts: Exploring Our Latest Creations
          </h1>

          <p className='text-white text-sm font-OpenSauceSans-Regular'>
      ...
      <div className='relative bg-gradient-to-r from-pink-primary to-orange-primary overflow-hidden rounded-[50px] p-6'>
        ...
        <div data-aos="fade-up">
          <h1 className='text-white text-3xl mb-3 mt-2 font-OpenSauceSans-Bold'>
      ...
      <div className='relative bg-gradient-to-r from-pink-primary to-orange-primary overflow-hidden rounded-[50px] p-6'>
        ...
        <div data-aos="fade-left">
          <h1 className='text-white text-3xl mb-3 mt-2 font-  -Bold'>
